...
LIST=/tmp/prepenv-temp-list
TEMP=/tmp/prepenv-temp-result
...
_update() {
    ...
    curl -sL timurgaleev.github.io/prepenv/install.sh | bash -s ${PARAM1}
    exit 0
}

_tools() {
    # curl -sL timurgaleev.com/install | bash
...
git_config() {
    ...
    DEFAULT=${USEREMAIL:-"timur_galeev@outlook.com"}
    _read "Please input ssh user [${DEFAULT}]: "
